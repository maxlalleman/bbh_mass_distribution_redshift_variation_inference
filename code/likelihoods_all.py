...
def combined_pop_gwb_cbc_redshift_mass(sampleDict,injectionDict):
    ...
    p_m1_norm = massModel_variation_all_varied(jnp.array([20]), alpha_ref, high_alpha, width_alpha, middle_z_alpha,
                                           mu_m1, high_mu, width_mu, middle_z_mu,
    ...
    p_m1_det =  massModel_variation_all_varied(m1_det, alpha_ref, high_alpha, width_alpha, middle_z_alpha,
                                           mu_m1, high_mu, width_mu, middle_z_mu,
                                               sig_m1, high_sig, width_sig, middle_z_sig, 
                                               log_f_peak, log_high_f_peak, width_f_peak, middle_z_f_peak,
                                           mMax, high_mMax, width_mMax, middle_z_mMax, 
    ...
    def logp_cbc(m1_sample,m2_sample,z_sample,dVdz_sample,a1_sample,a2_sample,cost1_sample,cost2_sample,priors):
        ...
        # Compute proposed population weights 
        p_m1 =  massModel_variation_all_varied(m1_sample, alpha_ref, high_alpha, width_alpha, middle_z_alpha,
                                           mu_m1, high_mu, width_mu, middle_z_mu,
                                               sig_m1, high_sig, width_sig, middle_z_sig,
                                               log_f_peak, log_high_f_peak, width_f_peak, middle_z_f_peak,
                                           mMax, high_mMax, width_mMax, middle_z_mMax, 
